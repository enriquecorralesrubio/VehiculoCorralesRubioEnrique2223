 ...
 */
public class VehiculoCorralesRubioEnrique2223 {
    ...
    public VehiculoCorralesRubioEnrique2223 ()
    {
    }
    // Constructor con parámetro para iniciar todas las propiedades de la clase
    
    
    public VehiculoCorralesRubioEnrique2223 (String nom, double precio, int stock)
    {
        this.nombre =nom;
        this.precio=precio;
        this.stock=stock;
